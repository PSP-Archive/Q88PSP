...
extern	char	*file_printer;			/* パラレル出力のファイル名 */
extern	char	*file_serialout;		/* シリアル出力のファイル名 */
extern	char	*file_serialin;			/* シリアル入力のファイル名 */
extern	char	*file_tapeload;			/* テープ入力のファイル名   */
extern	char	*file_tapesave;			/* テープ出力のファイル名   */
...
extern int highspeed_n88rom;	/* MAIN-ROM バンク選択時、真	    */



	/**** PCG ****/

extern	int	use_pcg;	/* 真で、PCG-8100サポート	*/
